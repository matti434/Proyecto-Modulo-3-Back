...
const obtenerProducto = async (req, res, next) => {
  try {
    ...
    const productosResponse = productos.map((p) => ({
      ...
      id: p._id,
      nombre: p.nombre,
      precio: Number(precioParaDesarrollo(p.precio)),
...
const obtenerProductoPorId = async (req, res, next) => {
  try {
    ...
    res.json({
      ...
      precio: Number(precioParaDesarrollo(producto.precio)),
  ...
  try {
    ...
    res.json({
      ...
      producto: {
        ...
        precio: Number(precioParaDesarrollo(productoActualizado.precio)),
